/*
Based on the following query, there are a couple of apps that have multiple prices, but on inspection, neither looks like a good candidate for purchase, so I'm simply going to take the MAX price to calculate the purchase price.
*/
(
	SELECT
		name,
